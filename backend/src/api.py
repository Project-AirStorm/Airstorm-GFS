...
logging.basicConfig(level=logging.DEBUG)  # Keep your logs at DEBUG
for noisy_logger in (
    "watchdog",
    "watchdog.observers",
...
def get_location_info():
    try:
        ...
        if result:
            ...
            for component in result["address_components"]:
                ...
                # Country
                    ...
                    location_info["components"]["country_code"] = component[
                        "short_name"
                    ]
            ...
            if not location_info["components"]["city"]:
                for component in result["address_components"]:
                    if (
                        "sublocality" in component["types"]
        ...
        return (
            jsonify({"error": "Geocoding service unavailable", "details": str(e)}),
            503,
        )
    except Exception as e:
